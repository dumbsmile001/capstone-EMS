<div class="flex min-h-screen bg-gray-50">
    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto overflow-x-hidden">
        ...
        <div class="flex-1 p-6 mt-20 lg:mt-24">
            ...
            <div class="mb-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 ml-5">Track and manage event attendance using scanned tickets
                        </p>
                    </div>
                    <div class="flex items-center gap-4">
                        <a href="{{ route('dashboard.organizer') }}"
                            class="px-4 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 font-medium flex items-center gap-2 shadow-lg shadow-blue-200">
            ...
            <!-- Filters Card - Modern Design (Matching Admin View) -->
            ...
            @if (count($attendance) > 0)
                ...
                <!-- Modern Pagination (Matching Admin View) -->
            ...
            @else
                <!-- Empty State (Matching Admin View) -->
    ...
    <!-- Export Modal (Matching Admin View) -->
    <x-custom-modal model="showExportModal" maxWidth="lg" title="Export Attendance Report"
        description="Export current attendance data to Excel or CSV format" headerBg="green">
        <div class="space-y-6">
