            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-4 lg:p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <!-- In admin-dashboard.blade.php, replace the existing Create Event modal with this -->
        ...
        <form wire:submit.prevent="createEvent" class="space-y-5">
            ...
            <div class="flex space-x-3 pt-4 border-t-2 border-gray-100">
                ...
                <button type="submit"
                    ...
                    <!-- Event Details Modal -->
                   <!-- In admin-dashboard.blade.php, replace the existing Event Details modal with this -->
...
<x-custom-modal 
    model="showGenerateReportModal" 
    maxWidth="lg" 
    title="Export Users Report" 
    description="Export filtered user data to Excel or CSV format" 
    headerBg="green"
>
    <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-3 text-sm">
                <div class="space-y-2">
                    ...
                    <p class="text-green-700">
                        ...
                        <span class="text-green-600">{{ $filterGradeLevel ? 'Grade ' . $filterGradeLevel : 'All' }}</span>
                    </p>
                    <p class="text-green-700">
                        <span class="font-medium">Year Level:</span> 
                        <span class="text-green-600">{{ $filterYearLevel ? 'Year ' . $filterYearLevel : 'All' }}</span>
                    </p>
                </div>
                <div class="space-y-2">
                    <p class="text-green-700">
        ...
        <div class="p-4 bg-gray-50 rounded-xl border-2 border-gray-100">
            <label class="flex items-center space-x-3 cursor-pointer">
                <input type="checkbox" wire:model="includeHeaders" class="w-5 h-5 text-green-600 border-2 border-gray-300 rounded-lg focus:ring-green-500 focus:ring-2">
                <div>
        ...
        <div class="flex space-x-3 pt-4 border-t-2 border-gray-100">
            ...
            <div class="bg-white rounded-lg shadow-md p-6" x-data="{ activeTab: 'users' }">
                ...
                <div class="overflow-x-auto">
                    ...
                    {{-- Edit User Modal --}}
<x-custom-modal 
    model="showEditUserModal" 
    maxWidth="lg" 
    title="Edit User" 
    description="Update user information and academic details" 
    headerBg="blue"
>
    <form wire:submit.prevent="saveUser" class="space-y-6">
        <!-- Personal Information Section -->
        <div class="space-y-4">
            <h3 class="text-sm font-semibold text-gray-700 flex items-center space-x-2 pb-2 border-b border-gray-200">
    ...
    <div class="text-center space-y-6">
        ...
        <div class="space-y-2">
            ...
            <p class="text-sm text-gray-600">
                ...
                @if($deletingUser)
                <br>
                <span class="font-semibold text-red-600">User: {{ $deletingUser->first_name }} {{ $deletingUser->last_name }}</span>
                @endif
            </p>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-3 pt-4">
            ...
            <button type="button" wire:click="deleteUser"
                ...
                <span>Confirm Delete</span>
                    ...
                    <!-- In admin-dashboard.blade.php, replace the existing Edit Event modal with this -->
        ...
        <form wire:submit.prevent="updateEvent" class="space-y-5">
            ...
            <div class="flex space-x-3 pt-4 border-t-2 border-gray-100">
                ...
                <button type="submit"
                    ...
                    <x-custom-modal model="showDeleteModal" maxWidth="sm">
                        <form class="max-w-md mx-auto">
