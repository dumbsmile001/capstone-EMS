                ...
                <div class="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-green-700">
                            ...
                            <span
                                class="text-green-600">{{ $filterCreator && isset($creators[$filterCreator]) ? $creators[$filterCreator] : 'All' }}</span>
                        </p>
                        <p class="text-green-700">
                            <span class="font-medium">Sort:</span>
                            <span class="text-green-600">{{ ucfirst(str_replace('_', ' ', $sortField)) }}
                                ({{ $sortDirection }})</span>
                        </p>
                    </div>
                </div>
