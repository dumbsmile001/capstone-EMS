<div class="flex min-h-screen bg-gray-50">
    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto overflow-x-hidden">
        ...
        <div class="flex-1 p-6 mt-20 lg:mt-24">
            ...
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Event Attendance Overview</h1>
                    <p class="text-gray-600">Monitor attendance across all events and organizers</p>
                </div>
                                ...
                                @foreach ($attendance as $ticket)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-xs text-gray-500 mt-1">
                                                Organizer: {{ $ticket->registration->event->creator->first_name }} 
                                        ...
                                        <td class="px-6 py-4">
                                            @if ($ticket->registration->event->require_payment)
                                                ...
                                                <div class="text-xs">
                                                    ...
                                                    @else
                                                        <span class="text-red-600">{{ ucfirst($ticket->registration->payment_status) }}</span>
                                                    @endif
                                                </div>
                                            @else
                                                <span
    ...
    <x-custom-modal 
        ...
        description="Export attendance data to Excel or CSV format" 
        headerBg="green"
    >
        <div class="space-y-6">
