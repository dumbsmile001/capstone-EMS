       ...
       <!-- Google Login Section -->
        <div class="relative my-6">
            ...
            <div class="relative flex flex-col justify-center text-sm">
                ...
                class="w-full inline-flex items-center justify-center my-4 px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-white hover:bg-gray-50 transition-all duration-200 group cursor-pointer"
        ...
        <div class="mt-6 pt-6 border-t border-gray-100 text-center">
            <p class="text-xs text-gray-500">
                © {{ date('Y') }} Systems Plus Computer College. All rights reserved.
            </p>
        </div>
    </div>
</div>
