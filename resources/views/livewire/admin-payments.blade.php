<div>
    ...
    <div class="mb-4 p-4 bg-gray-50 border border-gray-200 rounded-lg">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-semibold text-gray-700">Event Payments</h3>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($payments as $payment)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-600">
                                {{ $payment->event->creator->first_name ?? 'N/A' }} {{ $payment->event->creator->last_name ?? '' }}
                            </td>
                            <td class="px-4 py-3 text-sm text-gray-600">
                                ...
                                @if ($payment->payment_status === 'verified')
                                    ...
                                    @if ($payment->payment_verified_at)
                                        <div class="text-xs text-gray-500 mt-1">
                                            {{ $payment->payment_verified_at->format('M j, Y') }}
                                        </div>
                                    @endif
        ...
        @else
            <div class="text-center py-8">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    There are no pending or verified payments in the system yet.
                </p>
            </div>
        @endif
    </div>
