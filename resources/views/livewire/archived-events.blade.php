                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($events as $event)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <!-- In archived-events.blade.php, update the date & time column (around line 130-140) -->
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex flex-col gap-1">
                                                <span
                                                    class="px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800 w-fit">
                                                    {{ ucfirst($event->category) }}
                                                </span>
                                                <span
                                                    class="px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-800 w-fit">
            ...
            @else
                ...
                <div class="text-center py-12 bg-white rounded-lg shadow">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        All your events are currently active.
                    </p>
                    <div class="mt-6">
                        <a href="{{ route('organizer.events') }}"
