...
@section('title', 'Terms and Conditions - SPCC Events')
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ url()->previous() }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 transition-colors">
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-blue-100">
            ...
            <div class="p-6 sm:p-8">
                ...
                <!-- Acceptance Actions -->
                @auth
                    @if(!auth()->user()->hasAcceptedLatestTerms() && $terms)
                    ...
                    @elseif(auth()->user()->hasAcceptedLatestTerms())
                        <div class="mt-8 pt-6 border-t border-gray-200">
